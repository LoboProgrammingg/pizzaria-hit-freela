...
const PIZZAS_SALGADAS = [
    ...
    { id: 9, name: 'Bacon', description: 'Molho, mussarela, bacon, ovos, azeitona e orégano', prices: [51.90, 73.90, 84.90, 98.90], image: 'media/flavors/ifood_ready/Bacon.jpeg' },
    ...
    { id: 16, name: 'Margherita', description: 'Molho, mussarela, manjericão fresco, tomate, alho gratinado, tomate seco, parmesão, azeitona e orégano', prices: [51.90, 73.90, 84.90, 98.90], image: 'media/flavors/ifood_ready/Margherita.jpeg' },
    { id: 17, name: 'Margherita Especial', description: 'Molho, mussarela de búfala, tomate cereja, manjericão, parmesão, azeitona e orégano', prices: [51.90, 73.90, 84.90, 98.90], image: 'media/flavors/ifood_ready/Margherita-especial.jpeg' },
    ...
    { id: 22, name: 'Filé Especial', description: 'Molho, mussarela, filé, tomate cereja, azeitona e orégano', prices: [53.90, 76.90, 93.90, 102.90], image: 'media/flavors/ifood_ready/File-Especial.jpeg' },
    { id: 23, name: 'Strogonoff de Filé', description: 'Molho, mussarela, filé, creme de leite, champignon, batata palha, azeitona e orégano', prices: [53.90, 76.90, 93.90, 102.90], image: 'media/flavors/ifood_ready/Strogonoff-file.jpeg' },
    { id: 24, name: 'Strogonoff de Frango', description: 'Molho, mussarela, peito de frango, creme de leite, palmito, azeitona, orégano e batata palha', prices: [53.90, 76.90, 93.90, 102.90], image: 'media/flavors/ifood_ready/strogonoff-frango.jpeg' },
    { id: 25, name: 'Frango Especial', description: 'Molho, mussarela, peito de frango, cebola, tomate seco, manjericão, azeitona e orégano', prices: [53.90, 76.90, 93.90, 102.90], image: 'media/flavors/ifood_ready/Frango-especial.jpeg' },
    ...
    { id: 28, name: 'Vegetariana', description: 'Molho, mussarela, champignon, tomate, cebola, pimentão verde, azeitona e orégano', prices: [53.90, 76.90, 93.90, 102.90], image: 'media/flavors/ifood_ready/Vegetariana.jpeg' },
    ...
    { id: 30, name: 'Rúcula', description: 'Molho, mussarela, rúcula, tomate seco, mussarela de búfala, azeitona e orégano', prices: [53.90, 76.90, 93.90, 102.90], image: 'media/flavors/ifood_ready/Rucula.jpeg' },
    ...
    { id: 34, name: 'Berinjela', description: 'Molho, mussarela, berinjela, alho, azeitona e orégano', prices: [53.90, 76.90, 93.90, 102.90], image: 'media/flavors/ifood_ready/Berinjela.jpeg' },
    { id: 35, name: 'Genovesa', description: 'Molho, mussarela, champignon, presunto, azeitona e orégano', prices: [51.90, 73.90, 84.90, 98.90], image: 'media/flavors/ifood_ready/Genovesa.jpeg' },
    ...
    { id: 41, name: 'Super Hit', description: 'Molho, mussarela, catupiry, presunto, calabresa, bacon, champignon, requeijão, cebola, azeitona e orégano', prices: [53.90, 76.90, 93.90, 102.90], image: 'media/flavors/ifood_ready/Super-hit.jpeg' },
    { id: 42, name: 'Pizza Hit', description: 'Molho, mussarela, catupiry, presunto, bacon, champignon, cebola, azeitona e orégano', prices: [51.90, 73.90, 84.90, 98.90], image: 'media/flavors/ifood_ready/hit.jpeg' },
    { id: 43, name: 'À Moda Araci', description: 'Molho, mussarela, frango, bacon, catupiry, cebola, azeitona e orégano', prices: [51.90, 73.90, 84.90, 98.90], image: 'media/flavors/ifood_ready/moda-araci.jpeg' },
