...
const PIZZAS_SALGADAS = [
    { id: 1, name: 'Mussarela', description: 'Molho, mussarela, parmesão, azeitona e orégano', prices: [55.90, 81.90, 90.90, 105.90], image: 'media/flavors/ifood_ready/Mussarela.jpeg' },
    { id: 2, name: 'Portuguesa', description: 'Molho, mussarela, presunto, tomate, ovos, cebola, pimentão, azeitona e orégano', prices: [55.90, 81.90, 90.90, 105.90], image: 'media/flavors/ifood_ready/Portuguesaa.jpeg' },
    { id: 3, name: 'Tradicional', description: 'Molho, mussarela, presunto, azeitona e orégano', prices: [55.90, 81.90, 90.90, 105.90], image: 'media/flavors/ifood_ready/Tradicional.jpeg' },
    { id: 4, name: 'Napolitana', description: 'Molho, mussarela, parmesão, tomate, azeitona e orégano', prices: [55.90, 81.90, 90.90, 105.90], image: 'media/flavors/ifood_ready/Napolitana.jpeg' },
    { id: 5, name: 'Calabresa', description: 'Molho, mussarela, calabresa, cebola, azeitona e orégano', prices: [55.90, 81.90, 90.90, 105.90], image: 'media/flavors/ifood_ready/Calabresa.jpeg' },
    { id: 6, name: 'Calabresa Especial', description: 'Molho, mussarela, calabresa moída pré-assada, catupiry, uma pitadinha de pimenta calabresa, cebola, azeitona e orégano', prices: [55.90, 81.90, 90.90, 105.90], image: 'media/flavors/ifood_ready/Calabresa-especial.jpeg' },
    { id: 7, name: 'Toscana', description: 'Molho, calabresa moída, mussarela, catupiry, azeitona e orégano', prices: [55.90, 81.90, 90.90, 105.90], image: 'media/flavors/ifood_ready/Toscana.jpeg' },
    { id: 8, name: 'Dom Camilo', description: 'Molho, mussarela, presunto, calabresa, creme de leite, azeitona e orégano', prices: [55.90, 81.90, 90.90, 105.90], image: 'media/flavors/ifood_ready/Dom-Camilo.jpeg' },
    { id: 9, name: 'Mexicana', description: 'Molho, mussarela, calabresa moída, pimenta calabresa, azeitona e orégano', prices: [55.90, 81.90, 90.90, 105.90], image: 'media/flavors/ifood_ready/Mexicana.jpeg' },
    { id: 10, name: 'Catupiry', description: 'Molho, mussarela, catupiry, azeitona e orégano', prices: [55.90, 81.90, 90.90, 105.90], image: 'media/flavors/ifood_ready/Catupiry.jpeg' },
    { id: 11, name: 'Frango com Catupiry', description: 'Molho, mussarela, peito de frango, catupiry, azeitona e orégano', prices: [55.90, 81.90, 90.90, 105.90], image: 'media/flavors/ifood_ready/Frango-Catupiry.jpeg' },
    { id: 12, name: 'Frango Especial', description: 'Molho, mussarela, peito de frango, cebola, tomate seco, manjericão, azeitona e orégano', prices: [59.90, 83.90, 102.90, 112.90], image: 'media/flavors/ifood_ready/Frango-especial.jpeg' },
    { id: 13, name: 'À Brasileira', description: 'Molho, mussarela, peito de frango, milho verde, azeitona e orégano', prices: [55.90, 81.90, 90.90, 105.90], image: 'media/flavors/ifood_ready/A-Brasileira.jpeg' },
    { id: 14, name: 'Atum', description: 'Molho, mussarela, atum, tomate, cebola, azeitona e orégano', prices: [59.90, 83.90, 102.90, 112.90], image: 'media/flavors/ifood_ready/Atum.jpeg' },
    { id: 15, name: 'Pizza Hit', description: 'Molho, mussarela, catupiry, presunto, bacon, champignon, cebola, azeitona e orégano', prices: [63.90, 87.90, 106.90, 116.90], image: 'media/flavors/ifood_ready/hit.jpeg' },
    { id: 16, name: 'Marguerita', description: 'Molho, mussarela, manjericão fresco, tomate, parmesão, azeitona e orégano', prices: [55.90, 81.90, 90.90, 105.90], image: 'media/flavors/ifood_ready/Margherita.jpeg' },
    { id: 17, name: 'Marguerita Especial', description: 'Molho, mussarela, manjericão fresco, tomate, alho gratinado, tomate seco, parmesão, azeitona e orégano', prices: [59.90, 83.90, 102.90, 112.90], image: 'media/flavors/ifood_ready/Margherita-especial.jpeg' },
    ...
    { id: 19, name: 'Bacon', description: 'Molho, mussarela, bacon, ovos, azeitona e orégano', prices: [55.90, 81.90, 90.90, 105.90], image: 'media/flavors/ifood_ready/Bacon.jpeg' },
    { id: 20, name: 'Alho e Óleo', description: 'Molho, mussarela, parmesão, alho gratinado no azeite, azeitona e orégano', prices: [55.90, 81.90, 90.90, 105.90], image: 'media/flavors/ifood_ready/Alho-e-Oleo.jpeg' },
    { id: 21, name: 'Lombo ao Creme', description: 'Molho, mussarela, lombinho canadense, requeijão cremoso, tomate, azeitona e orégano', prices: [55.90, 81.90, 90.90, 105.90], image: 'media/flavors/ifood_ready/Lombo-ao-Creme.jpeg' },
    { id: 22, name: 'Genovesa', description: 'Molho, mussarela, presunto, creme de leite, azeitona e orégano', prices: [55.90, 81.90, 90.90, 105.90], image: 'media/flavors/ifood_ready/Genovesa.jpeg' },
    { id: 23, name: 'Palmito', description: 'Molho, mussarela, palmito, tomate, azeitona e orégano', prices: [55.90, 81.90, 90.90, 105.90], image: 'media/flavors/ifood_ready/Palmito.jpeg' },
    { id: 24, name: 'Quatro Queijos', description: 'Molho, mussarela, catupiry, gorgonzola, provolone, parmesão, azeitona e orégano', prices: [63.90, 87.90, 106.90, 116.90], image: 'media/flavors/ifood_ready/Quatro-Queijos.jpeg' },
    { id: 25, name: 'Super Hit', description: 'Molho, mussarela, catupiry, presunto, calabresa, bacon, champignon, requeijão, cebola, azeitona e orégano', prices: [63.90, 87.90, 106.90, 116.90], image: 'media/flavors/ifood_ready/Super-hit.jpeg' },
    ...
    { id: 29, name: 'Moda Arací', description: 'Molho, mussarela, ricota, provolone, presunto, ovos, bacon e orégano', prices: [55.90, 81.90, 90.90, 105.90], image: 'media/flavors/ifood_ready/moda-araci.jpeg' },
    ...
    { id: 31, name: 'Escarola', description: 'Molho, mussarela, escarola, catupiry, bacon, azeitona e orégano', prices: [55.90, 81.90, 90.90, 105.90], image: 'media/flavors/ifood_ready/Escarola.jpeg' },
    { id: 32, name: 'Brócolis', description: 'Molho, mussarela, brócolis, bacon, alho gratinado, catupiry, azeitona e orégano', prices: [55.90, 81.90, 90.90, 105.90], image: 'media/flavors/ifood_ready/Brocolis.jpeg' },
    ...
    { id: 36, name: 'Milho', description: 'Molho, mussarela, milho, azeitona e orégano', prices: [55.90, 81.90, 90.90, 105.90], image: 'media/flavors/ifood_ready/milho.jpeg' },
    { id: 37, name: 'Milho com Catupiry', description: 'Molho, mussarela, catupiry, milho, azeitona e orégano', prices: [55.90, 81.90, 90.90, 105.90], image: 'media/flavors/ifood_ready/Milho-com-catupiry.jpeg' },
    { id: 38, name: 'Super Portuguesa', description: 'Molho, mussarela, presunto, calabresa, tomate, ovos, cebola, azeitona, pimentão e orégano', prices: [59.90, 83.90, 102.90, 112.90], image: 'media/flavors/ifood_ready/Super-Portuguesa.jpeg' },
    { id: 39, name: 'Super Quatro Queijos', description: 'Molho, mussarela, catupiry, gorgonzola, provolone, tomate seco, azeitona, parmesão e orégano', prices: [59.90, 83.90, 102.90, 112.90], image: 'media/flavors/ifood_ready/Super-quatro-queijos.jpeg' },
    { id: 40, name: 'Strogonoff de Frango', description: 'Molho, mussarela, peito de frango, creme de leite, palmito, azeitona, orégano e batata palha', prices: [63.90, 87.90, 106.90, 116.90], image: 'media/flavors/ifood_ready/strogonoff-frango.jpeg' },
    { id: 41, name: 'Strogonoff de Filé', description: 'Molho, mussarela, filé, creme de leite, champignon, batata palha, azeitona e orégano', prices: [63.90, 87.90, 106.90, 116.90], image: 'media/flavors/ifood_ready/Strogonoff-file.jpeg' },
    { id: 42, name: 'Filé Especial', description: 'Molho, mussarela, filé, tomate cereja, azeitona e orégano', prices: [59.90, 83.90, 102.90, 112.90], image: 'media/flavors/ifood_ready/File-Especial.jpeg' },
    { id: 43, name: 'Pantaneira', description: 'Molho, mussarela, carne seca, catupiry, creme de leite, banana da terra frita, azeitona e orégano', prices: [63.90, 87.90, 106.90, 116.90], image: 'media/flavors/ifood_ready/Pantanera.jpeg' },
    ...
    { id: 45, name: 'Camarão', description: 'Molho, mussarela, camarão, creme de leite, parmesão, batata palha, azeitona e orégano', prices: [72.90, 83.90, 112.90, 119.90], image: 'media/flavors/ifood_ready/Camarao.jpeg' },
    { id: 46, name: 'Bacalhau', description: 'Molho, mussarela, bacalhau refogado no azeite, tomate, pimentão, cebola, ovos, azeitona e orégano', prices: [72.90, 83.90, 112.90, 119.90], image: 'media/flavors/ifood_ready/Bacalhau.jpeg' },
    ...
    { id: 54, name: 'Presunto de Parma', description: 'Molho de tomate, mussarela de Búfala, tomate cereja, presunto de Parma, azeitona preta e orégano', prices: [76.90, 87.90, 116.90, 123.90], image: 'media/flavors/ifood_ready/presunto-de-parma.jpeg' },
    { id: 55, name: 'Vegetariana Hit', description: 'Molho de tomate, mussarela de Búfala, tomate cereja, palmito, brócolis, abobrinha, azeitona e orégano', prices: [72.90, 83.90, 112.90, 119.90], image: 'media/flavors/ifood_ready/Vegetariana-Hit.jpeg' }
];
