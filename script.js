...
const PIZZAS_SALGADAS = [
    ...
    { id: 6, name: 'Calabresa Especial', description: 'Molho, mussarela, calabresa moída pré-assada, catupiry, uma pitadinha de pimenta calabresa, cebola, azeitona e orégano', prices: [51.90, 73.90, 84.90, 98.90], image: 'media/flavors/ifood_ready/Calabresa-especial.jpeg' },
    ...
    { id: 9, name: 'Mexicana', description: 'Molho, mussarela, calabresa moída, pimenta calabresa, azeitona e orégano', prices: [51.90, 73.90, 84.90, 98.90], image: 'media/flavors/ifood_ready/Mexicana.jpeg' },
    ...
    { id: 14, name: 'Atum', description: 'Molho, mussarela, atum, tomate, cebola, azeitona e orégano', prices: [53.90, 76.90, 93.90, 102.90], image: 'media/flavors/ifood_ready/Atum.jpeg' },
    ...
    { id: 18, name: 'Aliche', description: 'Molho, mussarela, parmesão, aliche, azeitona e orégano', prices: [53.90, 76.90, 93.90, 102.90], image: 'media/flavors/ifood_ready/Aliche.jpeg' },
    ...
    { id: 20, name: 'Alho e Óleo', description: 'Molho, mussarela, parmesão, alho gratinado no azeite, azeitona e orégano', prices: [51.90, 73.90, 84.90, 98.90], image: 'media/flavors/ifood_ready/Alho-e-Oleo.jpeg' },
    ...
    { id: 22, name: 'Genovesa', description: 'Molho, mussarela, presunto, creme de leite, azeitona e orégano', prices: [51.90, 73.90, 84.90, 98.90], image: 'media/flavors/ifood_ready/Genovesa.jpeg' },
    { id: 23, name: 'Palmito', description: 'Molho, mussarela, palmito, tomate, azeitona e orégano', prices: [51.90, 73.90, 84.90, 98.90], image: 'media/flavors/ifood_ready/Palmito.jpeg' },
    { id: 24, name: 'Quatro Queijos', description: 'Molho, mussarela, catupiry, gorgonzola, provolone, parmesão, azeitona e orégano', prices: [51.90, 73.90, 84.90, 98.90], image: 'media/flavors/ifood_ready/Quatro-Queijos.jpeg' },
    ...
    { id: 28, name: 'Dom Valério', description: 'Molho, mussarela, palmito, catupiry, bacon, azeitona e orégano', prices: [53.90, 76.90, 93.90, 102.90], image: 'media/flavors/ifood_ready/Dom-Valerio.jpeg' },
    { id: 29, name: 'Moda Arací', description: 'Molho, mussarela, ricota, provolone, presunto, ovos, bacon e orégano', prices: [51.90, 73.90, 84.90, 98.90], image: 'media/flavors/ifood_ready/moda-araci.jpeg' },
    ...
    { id: 31, name: 'Escarola', description: 'Molho, mussarela, escarola, catupiry, bacon, azeitona e orégano', prices: [51.90, 73.90, 84.90, 98.90], image: 'media/flavors/ifood_ready/Escarola.jpeg' },
    { id: 32, name: 'Brócolis', description: 'Molho, mussarela, brócolis, bacon, alho gratinado, catupiry, azeitona e orégano', prices: [51.90, 73.90, 84.90, 98.90], image: 'media/flavors/ifood_ready/Brocolis.jpeg' },
    { id: 33, name: 'Brócolis com Berinjela', description: 'Molho, mussarela, brócolis, berinjela em pasta, azeitona e orégano', prices: [51.90, 73.90, 84.90, 98.90], image: 'media/flavors/ifood_ready/brocolis-berinjela.jpeg' },
    { id: 34, name: 'Berinjela', description: 'Molho, mussarela, berinjela em pasta, tomate seco, cebola, azeitona e orégano', prices: [53.90, 76.90, 93.90, 102.90], image: 'media/flavors/ifood_ready/Berinjela.jpeg' },
    ...
    { id: 36, name: 'Milho', description: 'Molho, mussarela, milho, azeitona e orégano', prices: [51.90, 73.90, 84.90, 98.90], image: 'media/flavors/ifood_ready/milho.jpeg' },
    { id: 37, name: 'Milho com Catupiry', description: 'Molho, mussarela, catupiry, milho, azeitona e orégano', prices: [51.90, 73.90, 84.90, 98.90], image: 'media/flavors/ifood_ready/Milho-com-catupiry.jpeg' },
    ...
    { id: 39, name: 'Super Quatro Queijos', description: 'Molho, mussarela, catupiry, gorgonzola, provolone, tomate seco, azeitona, parmesão e orégano', prices: [53.90, 76.90, 93.90, 102.90], image: 'media/flavors/ifood_ready/Super-quatro-queijos.jpeg' },
    ...
    { id: 43, name: 'Pantaneira', description: 'Molho, mussarela, carne seca, catupiry, creme de leite, banana da terra frita, azeitona e orégano', prices: [53.90, 76.90, 93.90, 102.90], image: 'media/flavors/ifood_ready/Pantanera.jpeg' },
    { id: 44, name: 'Suíça', description: 'Molho, mussarela, lombo canadense, catupiry, azeitona e orégano', prices: [51.90, 73.90, 84.90, 98.90], image: 'media/flavors/ifood_ready/Suica.jpeg' },
    { id: 45, name: 'Camarão', description: 'Molho, mussarela, camarão, creme de leite, parmesão, batata palha, azeitona e orégano', prices: [71.90, 81.90, 112.90, 119.90], image: 'media/flavors/ifood_ready/Camarao.jpeg' },
    { id: 46, name: 'Bacalhau', description: 'Molho, mussarela, bacalhau refogado no azeite, tomate, pimentão, cebola, ovos, azeitona e orégano', prices: [71.90, 81.90, 112.90, 119.90], image: 'media/flavors/ifood_ready/Bacalhau.jpeg' },
    { id: 47, name: 'Mussarela de Búfala', description: 'Molho, mussarela de búfala, rodelas de tomate, presunto, azeitona e orégano', prices: [53.90, 76.90, 93.90, 102.90], image: 'media/flavors/ifood_ready/Mussarela-bufala.jpeg' },
...
const PIZZAS_DOCES = [
    ...
    { id: 108, name: 'Chocolate com Castanha de Caju', description: 'Creme de leite, chocolate e castanha de caju', prices: [51.90, 73.90, 84.90, 98.90], image: null },
